...
Revision ID: 43de3ece029e
Revises: 
Create Date: 2025-02-17 14:21:03.837364
...
def upgrade() -> None:
    ...
    sa.Column('level', sa.Enum('GLOBAL', 'INTERNATIONAL', 'NATIONAL', 'SUBNATIONAL', 'LOCAL', 'CUSTOM', name='communitylevel'), nullable=False),
    ...
    op.create_index(op.f('ix_subnation_name'), 'subnation', ['name'], unique=True)
